...
class Connection(_mysql.connection):
    ...
    def __init__(self, *args, **kwargs):
        ...
        :param str pa***MASKED***:    pa***MASKED*** to use
        :param str pa***MASKED***:      alias of pa***MASKED*** (deprecated)
        ...
        :param str auth_plugin:
            ...
            `mysql_native_pa***MASKED***` or `caching_sha2_pa***MASKED***`
        ...
        :param str server_public_key_path:
            specify the path to a file RSA public key file for caching_sha2_pa***MASKED***.
        ...
        if "pa***MASKED***" in kwargs2:
            kwargs2["pa***MASKED***"] = kwargs2.pop("pa***MASKED***")
    ...
    def _set_attributes(self, host=None, user=None, pa***MASKED***=None, database="", port=3306,
