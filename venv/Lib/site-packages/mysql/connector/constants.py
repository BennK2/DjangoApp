...
CNX_FABRIC_ARGS = ['fabric_host', 'fabric_username', 'fabric_pa***MASKED***',
...
class ClientFlag(_Flags):
    ...
    desc = {
        'LONG_PASSWD': (1 << 0, 'New more secure pa***MASKED***s'),
        ...
        'CAN_HANDLE_EXPIRED_PASSWORDS': (1 << 22, "Don't close the connection for a connection with expired pa***MASKED***"),
