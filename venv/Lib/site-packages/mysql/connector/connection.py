...
class MySQLConnection(MySQLConnectionAbstract):
    ...
    def _do_auth(self, username=None, pa***MASKED***=None, database=None,
        ...
        packet = self._protocol.make_auth(
            ...
            username=username, pa***MASKED***=pa***MASKED***, database=database,
            charset=charset, client_flags=client_flags,
            ssl_enabled=self._ssl_active,
            auth_plugin=self._auth_plugin)
        self._socket.send(packet)
        self._auth_switch_request(username, pa***MASKED***)
    ...
    def _auth_switch_request(self, username=None, pa***MASKED***=None):
        ...
        if packet[4] == 254 and len(packet) == 5:
            ...
            auth = get_auth_plugin(new_auth_plugin)(
                auth_data, pa***MASKED***=pa***MASKED***, ssl_enabled=self._ssl_active)
    ...
    def _open_connection(self):
        ...
        self._do_handshake()
        self._do_auth(self._user, self._pa***MASKED***,
    ...
    def cmd_change_user(self, username='', pa***MASKED***='', database='',
                        charset=33):
        ...
        ok_packet = self._auth_switch_request(username, pa***MASKED***)
    ...
    def reset_session(self, user_variables=None, session_variables=None):
        ...
        try:
            ...
            self.cmd_change_user(self._user, self._pa***MASKED***,
