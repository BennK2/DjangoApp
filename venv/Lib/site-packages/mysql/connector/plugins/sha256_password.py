...
class MySQLSHA256PasswordAuthPlugin(MySQLAuthPlugin):
    ...
    def _prepare_pa***MASKED***(self) -> bytes:
        """Prepare and return pa***MASKED*** as as clear text.

        Returns:
            pa***MASKED*** (bytes): Prepared pa***MASKED***.
        """
