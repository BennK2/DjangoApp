...
class FabricTransport(Transport):
    ...
    def __init__(self, username, pa***MASKED***,  #pylint: disable=E1002
    ...
    def request(self, host, handler, request_body, verbose=0):
        ...
        if self._passmgr:
            self._passmgr.add_pa***MASKED***(None, uri, self._username,
                                       self._pa***MASKED***)
        if self.verbose:
...
class Fabric(object):
    ...
    def __init__(self, host, username=None, pa***MASKED***=None,
                 port=None,
    ...
    @property
    def pa***MASKED***(self):
        """Return pa***MASKED*** used to authenticate with Fabric"""
        return self._pa***MASKED***
        ...
        while counter != attempts:
            ...
            try:
                dbconfig = {
                    ...
                    'pa***MASKED***': self._fabric.pa***MASKED***
                }
                if self._fabric.ssl_config:
                    if not HAVE_SSL:
                        raise InterfaceError("Python does not support SSL")
