...
class MySQLAuthenticator:
    ...
    def __init__(self) -> None:
        """Constructor."""
        self._username: str = ""
        self._pa***MASKED***s: Dict[int, str] = {}
    ...
    def _switch_auth_strategy(
        ...
        Args:
            ...
            pa***MASKED***_factor: Up to three levels of authentication (MFA) are allowed,
                             hence you can choose the pa***MASKED*** corresponding to the 1st,
        ...
        self._auth_strategy = get_auth_plugin(
            ...
            username,
            self._pa***MASKED***s.get(pa***MASKED***_factor, ""),
    ...
    async def _mfa_n_factor(
        ...
        while pkt[4] == MFA_STATUS:
            if n_factor not in self._pa***MASKED***s:
            ...
            self._switch_auth_strategy(new_strategy_name, pa***MASKED***_factor=n_factor)
    ...
    async def _handle_server_response(
        ...
        Raises:
            errors.ErrorTypes: If got an ERROR response.
            NotSupportedError: If got Authentication with old (insecure) pa***MASKED***s.
        """
        if pkt[4] == AUTH_SWITCH_STATUS and len(pkt) == 5:
            raise NotSupportedError(
                "Authentication with old (insecure) pa***MASKED***s "
    ...
    async def authenticate(
        ...
        Args:
            ...
            pa***MASKED***1: Account's pa***MASKED*** factor 1.
            pa***MASKED***2: Account's pa***MASKED*** factor 2.
            pa***MASKED***3: Account's pa***MASKED*** factor 3.
        ...
        self._pa***MASKED***s = {1: pa***MASKED***1, 2: pa***MASKED***2, 3: pa***MASKED***3}
