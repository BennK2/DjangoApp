...
class MySQLProtocol(object):
    ...
    def _auth_response(self, client_flags, username, pa***MASKED***, database,
    ...
    def make_auth(self, handshake, username=None, pa***MASKED***=None, database=None,
        ...
        packet += self._auth_response(client_flags, username, pa***MASKED***,
                                      database,
                                      auth_plugin,
    ...
    def make_change_user(self, handshake, username=None, pa***MASKED***=None,
    ...
    def parse_handshake(self, packet):
        ...
        if capabilities & ClientFlag.PLUGIN_AUTH:
            ...
            res['auth_plugin'] = 'mysql_native_pa***MASKED***'
