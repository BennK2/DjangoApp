...
class MySQL41AuthPlugin(object):
    def __init__(self, username, pa***MASKED***):
        ...
        self._pa***MASKED*** = pa***MASKED***.encode("utf-8") \
            if isinstance(pa***MASKED***, UNICODE_TYPES) else pa***MASKED***
    ...
    def xor_string(self, hash1, hash2):
        """Encrypt/Decrypt function used for pa***MASKED*** encryption in
    ...
    def build_authentication_response(self, data):
        ...
        """
        if self._pa***MASKED***:
            h1 = hashlib.sha1(self._pa***MASKED***).digest()
